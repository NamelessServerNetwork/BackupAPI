return function(path) --generates avtion/site functions.
    ...
    siteCode = "--[[" .. tracebackPathNote .. "]] local args = {...}; local _E, _D, _S, requestData, request, header, cookie, Session, response, body = env, env.dyn, env.shared, args[1], args[1].request, args[1].headers, env.cookie, env.dyn.Session, {html = {}, error = {}}, env.dyn.html.Body.new(); " .. siteCode
